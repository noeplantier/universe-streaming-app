...
const NCFG: Record<string,NCfg> = {
  ...
  reel_submitted:     { icon:'cloud-upload',        color:C.mid,    filter:'system',      label:'Soumis',         route:_=>'/(tabs)/profile'                    },
  reel_approved:      { icon:'checkmark-circle',    color:C.green,  filter:'system',      label:'Reel validé',    route:d=>d.reel_id?`/reel/${d.reel_id}`:'/(tabs)/profile' },
  reel_rejected:      { icon:'close-circle',        color:C.error,  filter:'system',      label:'Reel rejeté',    route:_=>'/(tabs)/profile'                    },
