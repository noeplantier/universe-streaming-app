        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>Bon retour parmi les étoiles ✨</Text>
            </View>
            ...
            <View style={styles.form}>
              ...
              {/* Demo */}
              <TouchableOpacity testID="login-demo-btn" onPress={fillDemo} style={styles.demoBtn}>
                <Text style={styles.demoBtnText}>Utiliser le compte démo</Text>
              </TouchableOpacity>
            </View>

            <TouchableOpacity testID="login-register-link" onPress={() => router.replace('/(auth)/register')} style={styles.switchLink}>
...
const styles = StyleSheet.create({
  ...
  demoBtn: {
    ...
    borderWidth: 1, borderColor: 'rgba(140,46,186,0.3)', marginTop: 4,
  },
  demoBtnText: { color: COLORS.textTertiary, fontSize: 13 },
